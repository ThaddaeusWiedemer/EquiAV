#!/bin/bash
#SBATCH -J equiav_video            # Job name
...
#SBATCH --output=$WORK/logs/sbatch/equiav_video-%j.out       # File to which STDOUT will be written - make sure this is not on $HOME
#SBATCH --error=$WORK/logs/sbatch/equiav_video-%j.err        # File to which STDERR will be written - make sure this is not on $HOME
...
python ft_main.py \
    ...
    --lr 1e-4 \
    --ftmode video_only \
    --save_path /home/bethge/twiedemer43/code/avd/checkpoints/equiav/equiav_ft_video.pth \
    --no_wandb
