#!/bin/bash
#SBATCH -J equiav_audio            # Job name
...
#SBATCH --output=$WORK/logs/sbatch/equiav_audio-%j.out       # File to which STDOUT will be written - make sure this is not on $HOME
#SBATCH --error=$WORK/logs/sbatch/equiav_audio-%j.err        # File to which STDERR will be written - make sure this is not on $HOME
...
python ft_main.py \
    ...
    --lr 1e-4 \
    --ftmode audio_only \
    --save_path /home/bethge/twiedemer43/code/avd/checkpoints/equiav/equiav_ft_audio.pth \
    --no_wandb
